...
#include "avoidance_manager_units/multi_agent.hpp"
...
AvoidanceManager::AvoidanceManager(SimulationManager& simulation_manager,
    ...
    this->avoidance_manager_units.emplace(MagenticFieldVectorMode::MULTI_AGENT,
                                          std::make_unique<MultiAgent>(simulation_manager, real_wm, ms));
