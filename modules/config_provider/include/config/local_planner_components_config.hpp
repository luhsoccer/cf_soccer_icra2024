...
struct LocalPlannerComponentsConfig : public Config {
    ...
    DoubleParam angle_for_inverse =
        createDoubleParam("angle_for_inverse", "", "AvoidanceMode", L_PI / 2, L_PI / 2, L_PI);

    DoubleParam defense_area_margin =
        createDoubleParam("defense_area_margin", "Margin of defense area.", "defense_area", 0.0, 0.0, 1.0);
    DoubleParam defense_area_margin_stop =
        createDoubleParam("defense_area_margin_stop", "Margin of defense area.", "defense_area", 0.2, 0.0, 1.0);

    BoolParam avoid_boundaries =
        createBoolParam("avoid_boundaries", "Avoid the boundaries of the field", "Plotting", false);
