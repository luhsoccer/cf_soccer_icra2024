...
struct SkillsConfig : public Config {
    ...
    DoubleParam mark_radius_enemy = createDoubleParam(
        "mark_radius_enemy", "Constant radius distance to enemy while marking it [in m]", "MarkEnemy", 0.5, 0.18, 3.0);
    ...
    DoubleParam okto_skill_speed =
        createDoubleParam("okto_skill_speed", "Max speed of the oktopus", "Oktoskill", 2.0, 0.1, 10.0);
    ...
    DoubleParam defend_goal_on_circle_line_weight =
        createDoubleParam("defend_goal_circle_line_weight", "Weight of the line", "DefendGoalOnCircle", 1.0, 0.0, 1.1);

    DoubleParam defend_goal_on_circle_line_goal_cutoff = createDoubleParam(
        "defend_goal_circle_line_goal_cutoff", "Line cutoff at the goal side", "DefendGoalOnCircle", 0.0, -2.0, 2.0);
