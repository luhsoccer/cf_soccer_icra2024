...
void bindEnum(py::enum_<BodSkillNames>& instance) {
    ...
    instance.value("ReceiveBallWithoutCancellation", BodSkillNames::RECEIVE_BALL_WITHOUT_CANCELLATION);
    instance.value("GoalieIntercept", BodSkillNames::GOALIE_INTERCEPT);
    instance.value("DoNotInterfereWithBallPlacement", BodSkillNames::DO_NOT_INTERFERE_WITH_BALL_PLACEMENT);
    instance.value("MoveConstant", BodSkillNames::MOVE_CONSTANT);
    instance.value("MoveConstant2", BodSkillNames::MOVE_CONSTANT2);
