...
void GameControllerWindow::render(bool* open) {
    ...
    ImGui::SameLine();
    float offset = ImGui::GetCursorPosX() + btn_offset;
    ...
    ImGui::SetCursorPosX(offset);
    if (ImGui::Button("Download GC")) {
#ifdef _WIN32
        ShellExecute(NULL, "open", "https://github.com/RoboCup-SSL/ssl-game-controller", NULL, NULL, SW_SHOWNORMAL);
#else
        system("xdg-open https://github.com/RoboCup-SSL/ssl-game-controller");
#endif
    }
